...
![超过宽度的文本自动补省略号](assets\20260522_162825_unity-text-1.webp)
超过宽度的文本自动补省略号

![未超过宽度的文本完整显示](assets\20260522_163024_unity-text-2.webp)
未超过宽度的文本完整显示

![截掉省略号前面多余的空格](assets\20260522_163031_unity-text-3.webp)
截掉省略号前面多余的空格
